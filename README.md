...
## Petunjuk Penggunaan
* Download terlebih dahulu seluruh file
* Buka terminal di folder tempat file berada
* Ketik node nodeApp.js
* Pada browser pilihan, ketik http://localhost:8888/
* Data dari user sudah tersedia